...
'''
r"([A-Z][a-z]{2}\s[\d]{1,2}\s\d{1,2}:\d{1,2}:\d{1,2}).*\[(\d*)\]"

1st group

First letter should be upper then max of 2 lower. Space . digit 1 or 2 times. Space a digit : a digit : a digit

anything in between ending with [
