# Practice Notebook Reading and Writing Quiz

'''
n this exercise, we will test your knowledge of reading and writing files by playing around with some text files.
